...
from searcher.shared import ARTEFACTS_DIR
from searcher.file_utils import ensure_directories_present
...
_ROOT_FILE_NAME = 'house_price_search'
...
_RELATIVE_CONSOLE_OUTPUT_FILE_PATH = \
    f'{ARTEFACTS_DIR}/{_FILE_NAME_FOR_CONSOLE_OUTPUT}'
_FULL_CONSOLE_OUTPUT_FILE_PATH = \
    f'{_ROOT_DIR_PATH}/{_RELATIVE_CONSOLE_OUTPUT_FILE_PATH}'

_FILE_NAME_FOR_DEBUG_OUTPUT = 'debug_output.log'
_RELATIVE_DEBUG_OUTPUT_FILE_PATH = \
    f'{ARTEFACTS_DIR}/{_FILE_NAME_FOR_DEBUG_OUTPUT}'
_FULL_DEBUG_OUTPUT_FILE_PATH = \
    f'{_ROOT_DIR_PATH}/{_RELATIVE_DEBUG_OUTPUT_FILE_PATH}'
